...
%DIF DEL draft2.tex     Wed Jan 18 17:38:02 2017
%DIF ADD draft2.1.tex   Mon Jan 23 16:52:27 2017
%%
...
\title{Cosmological constraints from the redshift dependence of the volume effect: galaxy angular 2-point correlation function}
...
\begin{abstract}
\DIFaddbegin {\bf \DIFadd{Let us use 1) angular CF across the line-of-sight 2) $\xi_{\bot}$ rather than $\omega_{r_{\bot}}$}}
\DIFaddend We propose to use the redshift dependence of the galaxy angular 2-point correlation function (2pCF)
...
Using mock galaxy catalogues (containing millions of galaxies at redshifts 0, 0.5, 1, 1.5, 2) from the Horizon Run 4 N-body simulation, we find that the redshift evolution of the angular 2pCF shape, as a function of scale,
...
The method could be applicable to future large scale structure surveys, especially photometric surveys such as DES, LSST, 
...
\begin{figure*}
   ...
   \includegraphics[width=16cm]{fig4_c.eps}
   \includegraphics[width=16cm]{fig4_d.eps}
   }
...
%DIFDELCMD <    %\includegraphics[width=7cm]{Tpcf--contour.eps}
%DIFDELCMD <    %\includegraphics[width=16cm]{Tpcf--contour-others.eps}
%DIFDELCMD <    %\includegraphics[width=16cm,natwidth=52,natheight=40]{fig10.eps}
%DIFDELCMD <    \includegraphics[width=12cm]{fig9.eps}
%DIFDELCMD <    }
%DIFDELCMD <    %%%
\DIFdelendFL \DIFaddbeginFL \centering{
   ...
   \DIFaddendFL \caption{\label{fig_contours}
   \DIFaddbeginFL \DIFaddFL{Left: }\DIFaddendFL Likelihood contours (68.3\%, 95.4\%) in the $\Omega_m-w$ plane from our method, 
   ...
   \DIFaddbeginFL \DIFaddFL{Right: The constraints in case that one or two high redshift bins are not used. 
   }\DIFaddendFL }
\end{figure*}
...
\DIFadd{In case that we do not have high redshfit galaxies, the constraint becomes weaker.
...
The area of contour is further enlarged by $\approx 50\%$ if we only use galaxies at $z=$0 and 0.5}\DIFaddend .



\section{Concluding Remarks}

We have developed a method for constraining certain cosmological parameters by measuring the redshift evolution of the shape of the galaxy angular correlation function, $\hat \omega_{r_\perp}$.
...
which in turn leads to a redshift-dependent rescaling of $\hat \omega_{r_\perp}(r_\perp)$.
...
Our method is simpler and just uses the fact that in the correct cosmology the angular 2pCF shape
