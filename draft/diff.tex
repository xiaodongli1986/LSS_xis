...
%DIF DEL draft0.tex   Tue Oct  4 10:31:37 2016
%DIF ADD draft1.tex   Thu Oct  6 17:26:53 2016
%%
...
%DIF 56a57-58
 %DIF > 
\newcommand{\scr}{\textcolor{red}} %DIF > 
%DIF -------
...
\shortauthors{X.-D. Li, C. Cheng, C. Park, C.G. Sabiu, H. Park, J. Kim, S.E. Hong}
...
\affil{School of Physics, Korea Institute for Advanced Study, 85 Heogiro, Dongdaemun-gu, Seoul 130-722, Korea}
\author{Hyunbae Park, Cristiano G. Sabiu, }
...
\begin{abstract}
We \DIFaddbegin \DIFadd{propose to }\DIFaddend use the redshift dependence of the galaxy angular 2-point correlation function (2pCF)
\DIFdelbegin \DIFdel{shape 
to constrain cosmological parameters.
A wrongly adopted cosmology introduces }\DIFdelend \DIFaddbegin \DIFadd{for a purpose of cosmological constraints.
When an incorrect cosmological model is assumed for the coordinate transformation from redshift space to comoving space, 
it produces }{\it \DIFaddend redshift-dependent mis-scaling\DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin } \DIFadd{in }\DIFaddend the constructed galaxy distribution\DIFdelbegin \DIFdel{,
leading to }\DIFdelend \DIFaddbegin \DIFadd{.
As a result, we observe a }\DIFaddend redshift-dependent rescaling \DIFdelbegin \DIFdel{in the measured }\DIFdelend \DIFaddbegin \DIFadd{of the measured galaxy }\DIFaddend angular 2pCF.
We test our method on the HR4 mock galaxies having hundreds of millions of galaxies at redshifts 
\DIFdelbegin \DIFdel{0, 0.5, 1, 1.5, 2.
}\DIFdelend \DIFaddbegin \DIFadd{$0\leq z\leq2$.
}\DIFaddend We find the redshift evolution of shape of angular 2pCF, as a function of scale,
is sensitive to the adopted cosmological parameters\DIFdelbegin \DIFdel{. 
It }\DIFdelend \DIFaddbegin \DIFadd{,
and }\DIFaddend is relatively insensitive to the gravitational growth of structure,
the galaxy bias, and the \DIFdelbegin \DIFdel{redshift space }\DIFdelend \DIFaddbegin \DIFadd{redshift-space }\DIFaddend distortion.
Analyzing the 2pCF shape on scales $5  h^{-1} {\rm Mpc} \leq r_\perp \leq 40 h^{-1} {\rm Mpc}$, 
we derive tight constraints on $\Omega_m$ and $w$ \DIFaddbegin \DIFadd{with 68.3\% CL uncertainties of 0.015 and 0.05}\DIFaddend .
%Our method is complementary to current works using 2pCF to constrain cosmological parameters.
The method could be applicable to future \DIFdelbegin \DIFdel{photometric surveys like }\DIFdelend \DIFaddbegin \DIFadd{large scale structure surveys, especially the photometric surveys such as }\DIFaddend DES, LSST\DIFaddbegin \DIFadd{, 
}\DIFaddend to derive tight cosmological constraints.
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{This }\DIFaddend work is a \DIFdelbegin \DIFdel{continue }\DIFdelend \DIFaddbegin \DIFadd{continuation }\DIFaddend of our previous works \citep{Li2014,Li2015,Li2016}
as a strategy to \DIFdelbegin \DIFdel{constrain }\DIFdelend \DIFaddbegin \DIFadd{constraining }\DIFaddend cosmological parameters based on some nearly redshift-invariant physical quantity;
they are all powerful in \DIFdelbegin \DIFdel{constrain }\DIFdelend \DIFaddbegin \DIFadd{constraining }\DIFaddend cosmology and have a lot of \DIFdelbegin \DIFdel{merits}\DIFdelend \DIFaddbegin \DIFadd{merit}\DIFaddend ,
e.g., are less affected by the systematic effects introduced by non-linear clustering or RSD,
\DIFdelbegin \DIFdel{does }\DIFdelend \DIFaddbegin \DIFadd{do }\DIFaddend not require accurate \DIFdelbegin \DIFdel{modeling of galaxy clustering}\DIFdelend \DIFaddbegin \DIFadd{analytical modeling of the galaxy correlation function}\DIFaddend ,
and are applicable on \DIFdelbegin \DIFdel{relative }\DIFdelend \DIFaddbegin \DIFadd{relatively }\DIFaddend small clustering scales.
\end{abstract}
...
when }\DIFdelend %DIF > As one geometrical effect of cosmological parameters on LSS,  
...
Various \DIFdelbegin \DIFdel{statistically methods has }\DIFdelend \DIFaddbegin \DIFadd{statistical methods have }\DIFaddend been proposed to measure these effects.
The AP effect \DIFdelbegin \DIFdel{has been proposed to measure through }\DIFdelend \DIFaddbegin \DIFadd{can be measured through statistical study of }\DIFaddend the clustering of galaxies \citep{Ballinger1996,Matsubara1996}\DIFdelbegin \DIFdel{which }\DIFdelend \DIFaddbegin \DIFadd{.
This method }\DIFaddend has been applied to a series of LSS surveys
...
\DIFdelbegin \DIFdel{the alternative approaches using }\DIFdelend \DIFaddbegin \DIFadd{Alternative approaches uses }\DIFaddend the symmetry properties of galaxy pairs \citep{Marinoni2010,Jennings2011,BB2012}
and cosmic voids \citep{Ryden1995,LavausWandelt1995,Sutter2014,Qingqing2016}.
Methods proposed \DIFaddbegin \DIFadd{that are }\DIFaddend able to probe the volume effect include the number counting of 
...
%\bibiem[Kazin et al (2012)]{KSB2012}
%Kazin, E.A., S\'{a}nchez, A.G., Blanton, M.R. 2012, MNRAS, 419, 3223



%DIF < The  Alcock-Paczynski (AP) effect referes to
%DIF < the geometric distortion when incorrect cosmological models are assumed for 
%DIF < transforming redshift to comoving distance,
%DIF < induced by the fact that measured distances along and perpendicular to the line of sight are fundamentally different. 
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
%DIF < The AP effect can be measured through the staistial study of galaxies clustering  \citep{Ballinger1996,Matsubara1996,
%DIF < Outram2004,Blake2011,ChuangWang2012,Reid2012,Beutler2013,Linder2013,2014arXiv1407.2257S, Jeong2014,Sutter2014,2014ApJ...781...96L,Alam2016, Beutler2016, Sanchez2016},
%DIF < symmetry properties of galaxy pairs \citep{Marinoni2010,Jennings2011,BB2012},
%DIF < and cosmic voids \citep{Ryden1995,LavausWandelt1995,Sutter2014,Qingqing2016}.
%DIF < The main caveat of these methods is that,
%DIF < because the radial distances of galaxies are inferred from redshifts,
%DIF < AP tests are inevitably limited by redshift-space distortions (RSD) \citep{Ballinger1996},
%DIF < which leads to apparent anisotropy even if the adopted cosmology is correct.
%DIFDELCMD < 

%DIFDELCMD < %%%
%DIF < \cite{Li2014,Li2015,Li2016} proposed a novel strategy to measure the redshift dependence of AP.
%DIF < Anisotropies produced by the RSD effect are, although large,
%DIF < maintaining a nearly uniform magnitude over a large range of redshift,
%DIF < while the degree of anisotropies from the AP effect varies with redshift by much larger magnitude. 
%DIF < \citep{Li2016} applies this method to the SDSS-III BOSS DR12 galaxies, and obtained tight cosmological constraints 
%DIF < comparable to the mainstream probes of SNIa, BAO or CMB.
%DIF < This method could play an important role in deriving cosmological constraints from future LSS surveys.
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend In \cite{Li2014,Li2015,Li2016} we developed a novel strategy to probe $D_A$ and $H$ from LSS data.
%proposed a series of methods to probe the geometric information encoded in the LSS data.
We found \DIFdelbegin \DIFdel{fact }\DIFdelend that the AP or volume effect in general introduces a geometric distortion \DIFdelbegin \DIFdel{significantly evolves }\DIFdelend \DIFaddbegin \DIFadd{that evolves significantly }\DIFaddend with redshift;
this phenomenon can be utilized to distinguish the \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{AP effect }\DIFaddend from the other effects\DIFaddbegin \DIFadd{, }\DIFaddend such as the \DIFdelbegin \DIFdel{redshift space }\DIFdelend \DIFaddbegin \DIFadd{redshift-space }\DIFaddend distortion (RSD).
The radial distances of galaxies are inferred from the measured redshifts\DIFaddbegin \DIFadd{, }\DIFaddend which are distorted by the peculiar motion of galaxies, 
leading to apparent distortion in the redshift space galaxy distribution \citep{FOG,Kaiser1987,Ballinger1996}.
\DIFdelbegin \DIFdel{It }\DIFdelend \DIFaddbegin \DIFadd{This }\DIFaddend is the major systematic \DIFdelbegin \DIFdel{effects }\DIFdelend \DIFaddbegin \DIFadd{effect }\DIFaddend limiting our ability to probe the geometry of LSS from galaxy distribution.
We found its influence is significantly reduced \DIFdelbegin \DIFdel{in case of }\DIFdelend \DIFaddbegin \DIFadd{when }\DIFaddend studying the redshift dependence of the distortion.
...
We tested the idea on \DIFaddbegin \DIFadd{the }\DIFaddend Horizon Run 3 (HR3) N-body \DIFdelbegin \DIFdel{simulations }\DIFdelend \DIFaddbegin \DIFadd{simulation }\DIFaddend \citep{horizonrun},
showing \DIFaddbegin \DIFadd{that }\DIFaddend the redshift evolution of the \DIFdelbegin \DIFdel{statistical property of the }\DIFdelend gradient field 
can be used to infer unbiased constraints \DIFaddbegin \DIFadd{on }\DIFaddend cosmological parameters and \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{that it is, largely, }\DIFaddend insensitive to RSD.
The same topic was revisited in \cite{Li2015}, 
using \DIFdelbegin \DIFdel{the statistical tool of }%DIFDELCMD < {\it %%%
\DIFdelend \DIFaddbegin \DIFadd{a slightly modified version of the usual anisotropic }\DIFaddend galaxy two-point correlation function \DIFdelbegin %DIFDELCMD < } %%%
\DIFdelend (2pCF)\DIFdelbegin \DIFdel{as a function of angle}\DIFdelend , $\xi(\mu)$, 
where $\mu\equiv \cos \theta$ and $\theta$ is the direction between the connection of the galaxy pairs and the \DIFdelbegin \DIFdel{direction.
When incorrect cosmological parameters are }\DIFdelend \DIFaddbegin \DIFadd{line of sight.
When an incorrect cosmological model is }\DIFaddend adopted, 
the shape of $\xi(\mu)$ is altered due to the anisotropic \DIFdelbegin \DIFdel{shape }\DIFdelend \DIFaddbegin \DIFadd{distortion }\DIFaddend of the LSS (the AP effect), 
and the amplitude is shifted due to the change in the \DIFdelbegin \DIFdel{size of comoving volume }\DIFdelend \DIFaddbegin \DIFadd{comoving volume elements}\DIFaddend ;
both effects have significant redshift dependence.
\DIFdelbegin \DIFdel{The RSD effect , although }%DIFDELCMD < {\it %%%
\DIFdel{very significantly }%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \DIFadd{Although the RSD effect significantly }\DIFaddend distorts $\xi(\mu)$, 
\DIFdelbegin \DIFdel{exhibits }\DIFdelend \DIFaddbegin \DIFadd{it exhibits much }\DIFaddend less redshift evolution.
The method was applied to BOSS DR12 galaxies \citep{Li2016} to probe the redshift \DIFdelbegin \DIFdel{dependent }\DIFdelend \DIFaddbegin \DIFadd{dependence }\DIFaddend of the AP effect, 
and we \DIFdelbegin \DIFdel{come up with }\DIFdelend \DIFaddbegin \DIFadd{arrive at }\DIFaddend tight cosmological constraints comparable to \DIFdelbegin \DIFdel{the }\DIFdelend mainstream probes of SNIa, BAO, CMB\DIFdelbegin \DIFdel{and so on}\DIFdelend .

In this paper we continue our exploration of \DIFdelbegin \DIFdel{our }\DIFdelend \DIFaddbegin \DIFadd{this }\DIFaddend strategy and presented 
a new method using the redshift of the shape of \DIFaddbegin \DIFadd{the }\DIFaddend {\it galaxy angular 2pCF} as a function of radial scale, $\omega(r_{\bot})$,
...
We apply our method to \DIFdelbegin \DIFdel{the }\DIFdelend HR4 mock galaxies\DIFdelbegin \DIFdel{having hundreds of million }\DIFdelend \DIFaddbegin \DIFadd{, using hundreds of millions of }\DIFaddend galaxies at redshfits \DIFdelbegin \DIFdel{0-2
}\DIFdelend \DIFaddbegin \DIFadd{$0\leq z\leq2$
}\DIFaddend and develop the statistical procedure to constrain cosmological parameters.
...
In this section we briefly introduce the scaling effect caused by \DIFdelbegin \DIFdel{wrongly }\DIFdelend \DIFaddbegin \DIFadd{incorrectly }\DIFaddend assumed cosmological parameters.
...
We measure \DIFdelbegin \DIFdel{its }\DIFdelend \DIFaddbegin \DIFadd{their }\DIFaddend redshift span $\Delta z$ and angular size $\Delta \theta$,
then compute \DIFdelbegin \DIFdel{its }\DIFdelend \DIFaddbegin \DIFadd{their }\DIFaddend sizes in the radial and transverse directions using the following formulas
...
In the particular case of a flat universe composed \DIFdelbegin \DIFdel{by }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend a cold dark matter component and a constant EoS dark energy\DIFdelbegin \DIFdel{component}\DIFdelend , they take the forms
\DIFdelbegin \DIFdel{of
}\DIFdelend \begin{eqnarray}\label{eq:HDA}
...
\DIFdelbegin \DIFdel{In case wrong }\DIFdelend \DIFaddbegin \DIFadd{When incorrect }\DIFaddend values of $\Omega_m$ and $w$ are adopted, 
the inferred $\Delta r_{\parallel}$ and $\Delta r_{\perp}$ are \DIFaddbegin \DIFadd{also }\DIFaddend wrong,
...
\end{equation}
where ``true'' and ``wrong'' denote the values in the true cosmology and wrongly assumed cosmologies \DIFdelbegin \DIFdel{, }\DIFdelend respectively.
...
\DIFdelbegin \DIFdel{,
}\DIFdelend %$1.46\times 10^{-2}$, $1.30\times 10^{-2}$, $1.13\times 10^{-2}$, $0.98\times 10^{-2}$ and $0.73\times 10^{-2}\ (h^{-1} \rm Mpc)^{-3}$,
respectively.
...
The growth of structure \DIFdelbegin \DIFdel{strengths }\DIFdelend \DIFaddbegin \DIFadd{increases }\DIFaddend the clustering and \DIFdelbegin \DIFdel{make structures more compact }\DIFdelend \DIFaddbegin \DIFadd{results in more compact structures}\DIFaddend ,
while the volume effect \DIFdelbegin \DIFdel{maintain }\DIFdelend \DIFaddbegin \DIFadd{maintains }\DIFaddend the clustering pattern and uniformly \DIFdelbegin \DIFdel{re-scale the }\DIFdelend \DIFaddbegin \DIFadd{re-scales }\DIFaddend structures on all scales.
\DIFdelbegin \DIFdel{Their imprints }\DIFdelend \DIFaddbegin \DIFadd{The imprint of each of these effects }\DIFaddend on the large scale structure is different and should be distinguishable.
In the following \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{section }\DIFaddend we show that they affect the angular correlation function measurements in different ways, 
and \DIFaddbegin \DIFadd{thus }\DIFaddend can be easily separated.
...
\begin{figure*}
  ...
  Left and right panels \DIFdelbeginFL \DIFdelFL{whos }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{show }\DIFaddendFL the $x$, $y$ coordinates computed using the ``correct'' parameters $\Omega_m=0.26,\ w=-1$ 
  ...
  When the wrong cosmology is adopted, the covmoving distances \DIFdelbeginFL \DIFdelFL{is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{are }\DIFaddendFL mis-scaled and over-estimated by $25.6\%,47.3\%,62.2\%,71.7\%$ at redshifts of $0.5,1.0,1.5,2.5$, \DIFaddbeginFL \DIFaddFL{respectively,  }\DIFaddendFL leading to a clear redshift evolution of \DIFaddbeginFL \DIFaddFL{the }\DIFaddendFL sizes of structures.
   }
   % Need a better plot to show angular size variation!!!
\end{figure*}
...
The random catalogue consists of unclustered points uniformly distributed in \DIFdelbegin \DIFdel{a same size box}\DIFdelend \DIFaddbegin \DIFadd{the same space as the simulated data.}\DIFaddend . 
...
The \DIFdelbegin \DIFdel{sheet }\DIFdelend \DIFaddbegin \DIFadd{`sheet'-like }\DIFaddend shape of the subsample is \DIFdelbegin \DIFdel{close }\DIFdelend \DIFaddbegin \DIFadd{similar }\DIFaddend to the shape of redshift shells in the real observational case.
...
The average of the measurements in all subsamples is \DIFdelbegin \DIFdel{adopted }\DIFdelend \DIFaddbegin \DIFadd{taken }\DIFaddend as the 2pCF of the whole sample,
while the covariances of them are \DIFdelbegin \DIFdel{adopted as }\DIFdelend \DIFaddbegin \DIFadd{taken to be }\DIFaddend the covariance matrix (after multiplying \DIFaddbegin \DIFadd{by }\DIFaddend a factor of $1/\sqrt{119}$).
...
The upper-left panel of Figure \ref{fig_diffz} displays the angular 2pCF measured from HR4 mock galaxies. % (multiplied by scale $r$) in the five snapshot.
...
%On the contrary, at higher redshift we find $\omega(z=2)>\omega(z=1.5)>\omega(z=1)$,
...
\DIFdelbegin \DIFdel{Different from the large variation of amplitude among different redshifts }\DIFdelend \DIFaddbegin \DIFadd{Although there is large variation in amplitude between the different redshifts bins}\DIFaddend , 
%The shape of $r_\perp\omega$ also evolves with redshift.
the shape of $r_\perp\omega$  \DIFdelbegin \DIFdel{maintains }\DIFdelend \DIFaddbegin \DIFadd{remains }\DIFaddend similar at all redshifts;
...
and is much more significant at lower \DIFdelbegin \DIFdel{redshfit}\DIFdelend \DIFaddbegin \DIFadd{redshift}\DIFaddend .

In order to directly compare the shape of \DIFaddbegin \DIFadd{the }\DIFaddend 2pCF at different redshifts,
...
(although \DIFdelbegin \DIFdel{out method should is also }\DIFdelend \DIFaddbegin \DIFadd{our method should also be }\DIFaddend applicable).

In the upper-middle panel, the \DIFdelbegin \DIFdel{nice overlapping of the $\hat\omega_{r_\perp}$
more clearly shows the the small }\DIFdelend \DIFaddbegin \DIFadd{overlapping of $\hat\omega$
clearly show the minimal }\DIFaddend redshift evolution of the shape.
...
There is one detail in the analysis \DIFdelbegin \DIFdel{which }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend should be emphasized here.
In real observations we \DIFdelbegin \DIFdel{are observing }\DIFdelend \DIFaddbegin \DIFadd{may be selecting }\DIFaddend {\it different} \DIFdelbegin \DIFdel{objects in different redshift shells}\DIFdelend \DIFaddbegin \DIFadd{types of galaxies at different redshifts}\DIFaddend .
Considering this fact in the comparison of $\hat\omega_{r_\perp}$ 
we compare subsamples of galaxies at {\it different} locations.
As an \DIFdelbegin \DIFdel{exammple}\DIFdelend \DIFaddbegin \DIFadd{example}\DIFaddend , if at $z=0$ we take $\hat\omega_{r_\perp}$ measured within $0h^{-1}{\rm Mpc}<Z<105 h^{-1}{\rm Mpc}$,
at higher redshifts we then adopt measurement within $105h^{-1}{\rm Mpc}<Z<210 h^{-1}{\rm Mpc}$ for a \DIFdelbegin \DIFdel{comparision}\DIFdelend \DIFaddbegin \DIFadd{comparison}\DIFaddend .
%and take the difference between them to get $\delta \hat{r_\perp\omega}$.
%So we are always comparing 2pCF measured from different samples of galaxies.
If \DIFdelbegin \DIFdel{simply comparing }\DIFdelend \DIFaddbegin \DIFadd{we simply compare }\DIFaddend the 2pCF of \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend {\it same} subsample of galaxies at different redshifts, 
one would significantly underestimate the statistical \DIFdelbegin \DIFdel{undertainty }\DIFdelend \DIFaddbegin \DIFadd{uncertainty }\DIFaddend of $\delta \hat{\omega}_{r_\perp}$ by ignoring \DIFdelbegin \DIFdel{the }\DIFdelend cosmic variance.
...
The angular 2pCF of galaxy positions constructed in a \DIFdelbegin \DIFdel{wrong }\DIFdelend \DIFaddbegin \DIFadd{wrongly assumed }\DIFaddend cosmology $\Omega_m=0.05,\ w=-1.5$
is displayed in the lower panels of Figure \ref{fig_diffz}.
The mis-scaling uniformly shifts \DIFdelbegin \DIFdel{clustering patterns }\DIFdelend \DIFaddbegin \DIFadd{the clustering pattern }\DIFaddend on all scales, 
leading to a \DIFdelbegin \DIFdel{wrong }\DIFdelend \DIFaddbegin \DIFadd{biased }\DIFaddend $\hat \omega_{r_\perp}$\DIFaddbegin \DIFadd{, which is 
}\DIFaddend related with the \DIFdelbegin \DIFdel{correct one }\DIFdelend \DIFaddbegin \DIFadd{true $\hat \omega$ }\DIFaddend as
\begin{equation}
 \hat \omega_{r_\perp,\rm wrong}(r) = \hat \omega_{r_\perp, \rm correct}(\alpha_{\perp} r),
\end{equation}
a simple consequence of the fact that \DIFdelbegin \DIFdel{clustering patterns }\DIFdelend \DIFaddbegin \DIFadd{the clustering pattern }\DIFaddend at scale $r$ is rescaled to $\alpha_{\perp} r$.
The redshift evolution of $\alpha_{\perp}$ leads to redshift evolution of 
$\hat \omega_{r_\perp, \rm correct}$,
%Lower panels of Figure \ref{fig_diffz} shows the $r_\perp\omega$ in five 
...
\DIFdelbegin \DIFdel{With the increasing of }\DIFdelend \DIFaddbegin \DIFadd{When increasing }\DIFaddend redshift,
the peak location is shifted from \DIFdelbegin \DIFdel{$9h^{-1} \rm Mpc$ to $15 h^{-1}\rm Mpc$ }\DIFdelend \DIFaddbegin \DIFadd{$\sim9h^{-1} \rm Mpc$ to $\sim15 h^{-1}\rm Mpc$ }\DIFaddend at $z=2$,
...
The mis-scaling not only changes the shape of the 2pCF but also modifies its amplitude. %The amplitude of $r_\perp\omega$ is amplified due to the stretch of scale.
As is shown in the left panel, due to the stretch of scale the amplitude is enhanced at higher redshifts;
the higher the redshift, the \DIFdelbegin \DIFdel{more }\DIFdelend \DIFaddbegin \DIFadd{greater }\DIFaddend the enhancement.%the amplitude monotonically increases as a function of redshift.
...
\DIFaddbegin \DIFadd{In }\DIFaddend Sec. \ref{sec_2pCF_diffz} \DIFdelbegin \DIFdel{shows }\DIFdelend \DIFaddbegin \DIFadd{we showed }\DIFaddend that $\hat \omega_{r_\perp}$ measured from \DIFaddbegin \DIFadd{the
}\DIFaddend constant mass cut samples at different redshifts \DIFdelbegin \DIFdel{is close to each other}\DIFdelend \DIFaddbegin \DIFadd{show good agreement}\DIFaddend .
The gravitational growth of structure will not have \DIFaddbegin \DIFadd{a }\DIFaddend large impact on $\hat \omega_{r_\perp}$ on scales $\gtrsim5 h^{-1}$ Mpc\DIFdelbegin \DIFdel{.
Yet }\DIFdelend \DIFaddbegin \DIFadd{,
yet }\DIFaddend there are many other factors \DIFdelbegin \DIFdel{may introduce redshift evolution
,
}\DIFdelend \DIFaddbegin \DIFadd{that may induce redshift evolution
}\DIFaddend including galaxy bias, RSD, redshift error, and 
the redshift evolution of \DIFdelbegin \DIFdel{properties of galaxies such as the }\DIFdelend \DIFaddbegin \DIFadd{galaxies properties 
such as }\DIFaddend mass, morphology, color, concentration\DIFdelbegin \DIFdel{, and so on}\DIFdelend . 
Here we test two ``major'' systematical effects\DIFdelbegin \DIFdel{, the }\DIFdelend \DIFaddbegin \DIFadd{; }\DIFaddend galaxy bias and the RSD effect.

%The same as \cite{Li2014,Li2015,Li2016} we need to correct for the redshift evolution of $r_\perp\omega$ caused by effects other than the cosmological effect.

%Figure \ref{fig_diffz} already shows that, the growth of structure, especially in low redshift and on non-linear scales, 
%changes the shape of $r_\perp\omega$ and caused relative enhancement on $r\lesssim2 h^{-1}\rm Mpc$.
%So we limit the region of scale to $r>5h^{-1}\rm Mpc$ to minimize its effect.

\subsubsection{Galaxy Bias}

Galaxies are biased tracers of \DIFaddbegin \DIFadd{the }\DIFaddend dark matter field;
...
are imposed to create three \DIFaddbegin \DIFadd{\scr{four?} }\DIFaddend samples with different galaxy bias.
The measured angular 2pCF are displayed.

\DIFdelbegin \DIFdel{The different }\DIFdelend \DIFaddbegin \DIFadd{Different }\DIFaddend mass cuts result in large variation in the amplitude of the 2pCF (left panel),
while the shape of the \DIFaddbegin \DIFadd{\scr{normalised} }\DIFaddend 2pCF remains less affected (middle panel).
...
have amplitude of 2pCFs enhanced by $10\%,\ 50\%$ and $100\%$, \DIFaddbegin \DIFadd{respectively, 
}\DIFaddend while the change in the shape is only $0.5\%,\ 2\%$ and $4\%$.
...
The galaxy peculiar velocity \DIFdelbegin \DIFdel{contributes to }\DIFdelend \DIFaddbegin \DIFadd{contaminates }\DIFaddend the observed redshift and distorts 
the inferred galaxy radial position\DIFdelbegin \DIFdel{,
known as the redshift space distortion}\DIFdelend .
It is the major \DIFdelbegin \DIFdel{systematics }\DIFdelend \DIFaddbegin \DIFadd{systematic }\DIFaddend in our previous works \citep{Li2014,Li2015,Li2016}
...
(especially those close to the boundaries of shells) are \DIFdelbegin \DIFdel{classified to }\DIFdelend \DIFaddbegin \DIFadd{assigned to the }\DIFaddend wrong redshift shells.

\DIFdelbegin \DIFdel{The lower panel of Figure \ref{fig_sys} displays the RSD effect on 2pCF.
}\DIFdelend We shift the radial coordinates of galaxies according to the relation 
...
This lead to \DIFdelbegin \DIFdel{mis-classification }\DIFdelend \DIFaddbegin \DIFadd{misclassification }\DIFaddend of some galaxies when we split the box into slices.
%Then we split the whole box into 30 slices with thickness $105h^{-1}\rm Mpc$, 
%and measure the angular 2pCF.

\DIFdelbegin \DIFdel{Comparing the }\DIFdelend \DIFaddbegin \DIFadd{The lower panel of Figure \ref{fig_sys} shows the RSD effect on the 2pCF.
Comparing this }\DIFaddend plot with Figure \ref{fig_diffz} one \DIFaddbegin \DIFadd{can }\DIFaddend clearly see the effect of RSD.
The amplitude of \DIFaddbegin \DIFadd{the }\DIFaddend measured 2pCF is enhanced by $\sim 10\%$ \DIFdelbegin \DIFdel{in case of }\DIFdelend \DIFaddbegin \DIFadd{when }\DIFaddend considering the RSD effect 
\DIFdelbegin \DIFdel{.
The }\DIFdelend \DIFaddbegin \DIFadd{and the }\DIFaddend slop of $\hat\omega_{r_\perp}$ \DIFdelbegin \DIFdel{slightly suppressed.
While the }\DIFdelend \DIFaddbegin \DIFadd{is suppressed.
The }\DIFaddend redshift evolution of $\hat\omega_{r_\perp}$ is still small\DIFdelbegin \DIFdel{...
Although the pattern is a little modified..}\DIFdelend \DIFaddbegin \DIFadd{, remain $\lesssim4\%$ at $0.5\leq z \leq 2$}\DIFaddend .
So RSD \DIFdelbegin \DIFdel{is not a big issue here... }%DIFDELCMD < {\bf %%%
\DIFdel{after anna jobs finished we have better plots and re-revise this section }%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{should not very affect the application of our method as long as it is precisely modeled and corrected.
}\DIFaddend %If looking at the redshift evolution,
%the curves $\hat{r_\perp\omega} - \hat{r_\perp\omega}(z=0)$ displayed in the right panel,
...
also results in fuzzy boundaries of shells and \DIFdelbegin \DIFdel{mis-classification }\DIFdelend \DIFaddbegin \DIFadd{misclassification }\DIFaddend of galaxies.
...
\begin{figure*}
   \centering{
   \includegraphics[width=16cm]{fig4_a.eps}
   \includegraphics[width=16cm]{fig4_b.eps}
   }
...
\DIFdelbegin \DIFdel{A cosmology resulting in smaller evolution is considered to be more likely to be the correct one}\DIFdelend \DIFaddbegin \DIFadd{Adopting the correct cosmological model will resulting in minimal evolution of the normalised 2pCF.
Thus we proceed to construct a quantitative likelihood estimator}\DIFaddend .
The procedure here is very similar to \DIFdelbegin \DIFdel{what we did in }\DIFdelend \cite{Li2014,Li2015,Li2016}.
...
As mentioned \DIFdelbegin \DIFdel{before}\DIFdelend \DIFaddbegin \DIFadd{previously}\DIFaddend , for a robust estimation of \DIFaddbegin \DIFadd{the }\DIFaddend covariance matrix, 
...
In the case that one \DIFdelbegin \DIFdel{have }\DIFdelend \DIFaddbegin \DIFadd{has }\DIFaddend 2\,000 mocks the rescaling is less than 1.02.


%estimated from the 72 sets of PSB mock galaxies identified from HR3 N-body simulation.


Figure \ref{fig_cosmo} displays the 2pCF and the likelihood values \DIFdelbegin \DIFdel{in case of }\DIFdelend \DIFaddbegin \DIFadd{when }\DIFaddend adopting 
the four \DIFdelbegin \DIFdel{wrong cosmologies of }\DIFdelend \DIFaddbegin \DIFadd{incorrect cosmologies used in }\DIFaddend Figure \ref{fig_xyquan}.
...
and find \DIFaddbegin \DIFadd{that }\DIFaddend these cosmologies are disfavored 
...
We \DIFdelbegin \DIFdel{get tight constraint }\DIFdelend \DIFaddbegin \DIFadd{obtain tight constraints }\DIFaddend on the two paramters.
...
The thin shape of \DIFaddbegin \DIFadd{the }\DIFaddend contour implies that, 
when combining with the another observational data with \DIFaddbegin \DIFadd{a }\DIFaddend different direction of degeneracy (e.g. CMB, BAO),
\DIFaddbegin \DIFadd{a }\DIFaddend very tight combined constraint can be obtained.
In \DIFaddbegin \DIFadd{the }\DIFaddend case of fixing one parameter at its best-fit value and \DIFdelbegin \DIFdel{constrain the otherone,
one obtain }\DIFdelend \DIFaddbegin \DIFadd{constraining the other,
one obtains }\DIFaddend 1$\sigma$ \DIFdelbegin \DIFdel{uncertainty }\DIFdelend \DIFaddbegin \DIFadd{uncertainties }\DIFaddend of $\delta\Omega_m\approx0.002,\delta w\approx0.01$. 


\section{Concluding Remarks}

We developed a method \DIFaddbegin \DIFadd{of }\DIFaddend measuring the redshift of the shape of \DIFaddbegin \DIFadd{the }\DIFaddend galaxy angular correlation function, $\hat \omega_{r_\perp}$, to constrain cosmology.
A wrongly adopted cosmology \DIFdelbegin \DIFdel{result }\DIFdelend \DIFaddbegin \DIFadd{results }\DIFaddend in redshift-dependent mis-scaling in the constructed galaxy distribution,
which leads to \DIFaddbegin \DIFadd{a }\DIFaddend redshift-dependent rescaling of $\hat \omega_{r_\perp}(r_\perp)$.
...
In this analysis we restrict our focus to the rescaling in \DIFaddbegin \DIFadd{the }\DIFaddend angular direction.
...
Our method is simpler and \DIFdelbegin \DIFdel{just }\DIFdelend \DIFaddbegin \DIFadd{simply }\DIFaddend utilizes the fact in the correct cosmology the angular 2pCF shape
does not exhibit \DIFdelbegin \DIFdel{much }\DIFdelend \DIFaddbegin \DIFadd{significant }\DIFaddend redshift evolution.
...
\cite{Li2015,Li2016} shows that using the redshift \DIFdelbegin \DIFdel{dependent of AP effect 
}\DIFdelend \DIFaddbegin \DIFadd{dependence of the AP effect, 
}\DIFaddend one can derive very tight cosmological constraint.
%We hope this method also.
...
with a particular emphasis to the {\it photometric surveys}\DIFdelbegin \DIFdel{,
such as DES (300 million }\DIFdelend \DIFaddbegin \DIFadd{.
DES will probe hundreds of millions of }\DIFaddend galaxies at $z\lesssim1.5$\DIFdelbegin \DIFdel{) and LSST (20 billion }\DIFdelend \DIFaddbegin \DIFadd{, 
and LSST will probe tens of billions of }\DIFaddend galaxies at $z\lesssim2$\DIFdelbegin \DIFdel{) }%DIFDELCMD < [%%%
\DIFdel{CHECK THEM!!!}%DIFDELCMD < ]%%%
\DIFdel{.
These surveysprobe a large amount of galaxies 
...
%DIF > and the redshift error will not quite affect the angular 2pCF measurement 
%DIF > as long as the redshift dependence of the photometric redshift can be reliably understood.
}\DIFaddend 


Our series of works \cite{Li2014,Li2015,Li2016}, together with this analysis, 
and also \citep{topology,MS2016},
are introducing a new strategy to constrain cosmology from \DIFdelbegin \DIFdel{LSS data}\DIFdelend \DIFaddbegin \DIFadd{galaxy clustering}\DIFaddend .
We seek \DIFdelbegin \DIFdel{for }\DIFdelend the statistical pattern which \DIFdelbegin \DIFdel{maintains nearly }\DIFdelend \DIFaddbegin \DIFadd{remains }\DIFaddend constant at all redshifts;
...
This avoids the \DIFdelbegin \DIFdel{difficult modeling of galaxy bias, galaxy clustering }\DIFdelend \DIFaddbegin \DIFadd{difficulty in the analytical modeling the galaxy clustering, galaxy bias }\DIFaddend and RSD,
\DIFaddbegin \DIFadd{and }\DIFaddend enables reliable cosmological constraint on scales much smaller than BAO.
...
%DIF < \bibitem[Bueno Belloso et al. (2012)]{BB2012}
%DIF < Bueno Belloso, A., Pettinari, G.W., Meures, N., \& Percival, W.J. 2012, Phys. Rev. D, 86, 023530
\DIFaddbegin \bibitem[Bueno Belloso et al. (2012)]{BB2012}
\DIFadd{Bueno Belloso, A., Pettinari, G.W., Meures, N., \& Percival, W.J. 2012, Phys. Rev. D, 86, 023530
}\DIFaddend 
