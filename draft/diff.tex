...
%DIF ADD draft_cris.tex   Mon Oct  3 13:17:23 2016
%%
...
\begin{abstract}
We use the redshift dependence of the galaxy angular 2-point correlation function (2pCF) shape 
to constrain cosmological parameters.
A wrongly adopted cosmology introduces redshift-dependent mis-scaling 
of the constructed galaxy distribution,
leading to redshift-dependent rescaling in the measured angular 2pCF.
We test our method on the HR4 mock galaxies having hundreds of millions of galaxies at redshifts 
0, 0.5, 1, 1.5, 2.
We find the redshift evolution of shape of angular 2pCF, as a function of scale,
is sensitive to the adopted cosmological parameters. 
It is relatively insensitive to the gravitational growth of structure,
the galaxy bias, and the redshift space distortion.
...
The method could be applicable to future photometric surveys like DES, LSST 
to derive tight cosmological constraints.
The work is a continue of our previous works \citep{Li2014,Li2015,Li2016}
as a strategy to constrain cosmological parameters based on some nearly redshift-invariant physical quantity;
they are all powerful in constrain cosmology and have a lot of merits,
e.g., are less affected by the systematic effects introduced by non-linear clustering or RSD,
does not require accurate modeling of galaxy clustering,
and are applicable on relative small clustering scales.
\end{abstract}
...
We found fact that the AP or volume effect in general introduces a geometric distortion \DIFdelbegin \DIFdel{significantly evolves }\DIFdelend \DIFaddbegin \DIFadd{that evolves significantly }\DIFaddend with redshift;
this phenomenon can be utilized to distinguish the \DIFaddbegin \DIFadd{\scr{AP effect(?)} }\DIFaddend the from the other effects such as the redshift space distortion (RSD).
...
We tested the idea on \DIFaddbegin \DIFadd{the }\DIFaddend Horizon Run 3 (HR3) N-body simulations \citep{horizonrun},
showing the redshift evolution of the statistical property of the gradient field 
can be used to infer unbiased constraints \DIFaddbegin \DIFadd{on certain }\DIFaddend cosmological parameters and \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{that it is, largely, }\DIFaddend insensitive to RSD.
...
When \DIFdelbegin \DIFdel{incorrect cosmological parameters are }\DIFdelend \DIFaddbegin \DIFadd{an incorrect cosmological model is }\DIFaddend adopted, 
...
The RSD effect, \DIFdelbegin \DIFdel{although }%DIFDELCMD < {\it %%%
\DIFdel{very significantly }%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \DIFadd{significantly }\DIFaddend distorts $\xi(\mu)$, \DIFdelbegin \DIFdel{exhibits }\DIFdelend \DIFaddbegin \DIFadd{however it
exhibits much }\DIFaddend less redshift evolution.
...
the main factor leads to redshift evolution of galaxy distribution is the gravitational growth of structure.
With the decreasing the redshift, we clearly see the clusters and filaments form and grow.
On the other hand, when the wrong cosmology is adopted, there is an artificial scaling of scales in the constructed map.
The separations among galaxies are over-estimated by 
$25.6\%,47.3\%,62.2\%,71.7\%$ at redshifts of $0.5,1.0,1.5,2.5$,
leading to a clear redshift evolution of sizes of structures.}
}\DIFaddend 

The growth of structure \DIFdelbegin \DIFdel{strengths }\DIFdelend \DIFaddbegin \DIFadd{enhances }\DIFaddend the clustering and \DIFdelbegin \DIFdel{make structures more compact }\DIFdelend \DIFaddbegin \DIFadd{results in more compact structures}\DIFaddend ,
while the volume effect \DIFdelbegin \DIFdel{maintain }\DIFdelend \DIFaddbegin \DIFadd{maintains }\DIFaddend the clustering pattern and uniformly \DIFdelbegin \DIFdel{re-scale }\DIFdelend \DIFaddbegin \DIFadd{re-scales }\DIFaddend the structures on all scales.
...
while the covariances of them are \DIFdelbegin \DIFdel{adopted as }\DIFdelend \DIFaddbegin \DIFadd{taken to be }\DIFaddend the covariance matrix (after multiplying a factor of $1/\sqrt{119}$).
...
\DIFdelbegin \DIFdel{Different }\DIFdelend \DIFaddbegin \DIFadd{Apart }\DIFaddend from the large variation \DIFdelbegin \DIFdel{of amplitude among different redshifts }\DIFdelend \DIFaddbegin \DIFadd{in amplitude between the different redshifts bins}\DIFaddend , 
%The shape of $r_\perp\omega$ also evolves with redshift.
the shape of $r_\perp\omega$  \DIFdelbegin \DIFdel{maintains }\DIFdelend \DIFaddbegin \DIFadd{is }\DIFaddend similar at all redshifts;
...
more clearly shows the the small }\DIFdelend \DIFaddbegin \DIFadd{overlapping $\hat\omega$'s
...
one would significantly underestimate the statistical \DIFdelbegin \DIFdel{undertainty }\DIFdelend \DIFaddbegin \DIFadd{uncertainty }\DIFaddend of $\delta \hat{\omega}_{r_\perp}$ by ignoring the cosmic variance.
...
the higher the redshift, the more the enhancement.%the amplitude monotonically increases as a function of redshift.
...
}\DIFaddend constant mass cut samples at different redshifts \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{are relatively }\DIFaddend close to each other.
The gravitational growth of structure will not have \DIFaddbegin \DIFadd{a }\DIFaddend large impact on $\hat \omega_{r_\perp}$ on scales $\gtrsim5 h^{-1}$ Mpc.
Yet there are many other factors \DIFdelbegin \DIFdel{may introduce }\DIFdelend \DIFaddbegin \DIFadd{that may induce }\DIFaddend redshift evolution,
...
such as }\DIFaddend mass, morphology, color, concentration, and so on. 
Here we test two ``major'' systematical effects\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{; }\DIFaddend the galaxy bias and the RSD effect.
...
\DIFdelbegin \DIFdel{.
The }\DIFdelend \DIFaddbegin \DIFadd{and the }\DIFaddend slop of $\hat\omega_{r_\perp}$ \DIFaddbegin \DIFadd{is }\DIFaddend slightly suppressed.
