...
As a result, we observe a redshift-dependent rescaling of the measured $\xi(r_{\bot})$.
Using mock galaxy catalogues (containing millions of galaxies at redshifts 0, 0.5, 1, 1.5, 2) from the Horizon Run 4 N-body simulation, we find that the redshift evolution of the $\xi(r_{\bot})$ shape, as a function of scale,
...
The mis-scaling not only changes the shape of the 2pCF but also modifies its amplitude. %The amplitude of $r_\perp\xi$ is amplified due to the stretch of scale.
