...
\begin{figure*}
   ...
   \includegraphics[height=5.9cm]{fig8_0.5.eps}
   \includegraphics[height=5.9cm]{fig8_1.eps}
   \includegraphics[height=5.9cm]{fig8_1.5.eps}
   \includegraphics[height=5.9cm]{fig8_2.eps}
   }
...
\begin{figure*}
   ...
   \includegraphics[height=5.9cm]{fig8_wrongcos_0.5.eps}
   \includegraphics[height=5.9cm]{fig8_wrongcos_1.eps}
   \includegraphics[height=5.9cm]{fig8_wrongcos_1.5.eps}
   \includegraphics[height=5.9cm]{fig8_wrongcos_2.eps}
   }
   \caption{\label{fig_scatter}
  bb
   }
