...
\begin{abstract}
We develop a methodology to use the redshift dependence of the galaxy 2-point correlation function across the line-of-sight (2pCF), $\xi(r_{\bot})$, as a probe of cosmological parameters. 
...
the galaxy two-point correlation function (2pCF) across the line-of-sight, $\xi(r_{\bot})$. 
