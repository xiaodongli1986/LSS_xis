...
for a purpose of cosmological constraints.
...
and is relatively insensitive to the gravitational growth of structure,
...
as a strategy to constraining cosmological parameters based on some nearly redshift-invariant physical quantity;
they are all powerful in constraining cosmology and have a lot of merit,
...
%    \includegraphics[height=8cm]{smu.eps}
   ...
   \caption{\label{fig_cosmo}
    ...
    The redshift evolution of angular 2pCF shape in these wrong cosmologies are detected at high CL.
   }
\end{figure*}
