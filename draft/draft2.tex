...
\begin{figure*}
  ...
  and the RSD effect is considered (the error bar is a bit larger since for an illustration purpose we only do the computation for 1/30 of the whole sample). } 
\end{figure*}
...
We see the redshfit evolution of $\hat \omega_{r_\perp}$ is still as small as $\lesssim5\%$, similar to the case of using constant mass cut sample.
